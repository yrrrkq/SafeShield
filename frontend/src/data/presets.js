export const ATTACK_PRESETS = [
  {
    ...
    timestamp: "방금 전",
    smsText: "[CJ대한통운] 고객님의 운송장(6820-****) 도로명 주소 불일치로 배송이 보류되었습니다. 즉시 주소 확인 및 앱 업데이트 후 배송 재개 요청 바랍니다. http://127.0.0.1:9100/parcel",
    url: "http://127.0.0.1:9100/parcel",
  ...
  },
  {
    ...
    timestamp: "12분 전",
    smsText: "[모바일청첩장] 저희 두 사람의 소중한 시작을 함께 축복해 주세요. 모바일 청첩장 보기 및 모바일 식권 다운로드: http://127.0.0.1:9100/wedding",
    url: "http://127.0.0.1:9100/wedding",
  ...
  },
  {
    ...
    senderNumber: "1397",
    timestamp: "1시간 전",
    smsText: "[서민금융진흥원] 귀하는 2026 정부 특별 저금리(연 2.1%) 대환대출 지원 대상자입니다. 한도 즉시 조회 및 전용 보안앱 설치: http://127.0.0.1:9100/loan",
    url: "http://127.0.0.1:9100/loan",
  ...
  },
  {
    ...
    timestamp: "어제",
    smsText: "[경찰청 사이버수사국] 귀하의 명의가 대포통장 범죄에 연루되었습니다. 자산 동결 방지를 위해 즉시 경찰 공용 안심 보안인증앱을 설치하십시오: http://127.0.0.1:9100/police",
    url: "http://127.0.0.1:9100/police",
